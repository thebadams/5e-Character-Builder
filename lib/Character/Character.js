...
//weight construction and validation
    if(typeof weight === 'string' || weight === undefined || weight === null) {
      if(typeof weight === 'string' && weight.length < 1) {
        throw new Error('Weight Must Be At Least 1 Character Long');
      }
      this._weight = weight
    } else {
      throw new TypeError('Please Provide A String For Weight');
    }
