  ...
  describe('Character Class Properties', () => {
    ...
    describe('Character Weight Property', () => {
      ...
      describe('Weight Getters and Setters', () => {
        test.todo('Weight getter should return undefined if no weight has been provided')
        test.todo('Weight setter should successfully set weight property')
      })
      describe('Weight Property Error Handling', () => {
        describe('Type Errors', () => {
          test.todo('If A Non String Is Passed In, Throw A Type Error')
        })
        describe('String Validation', () => {
          test.todo('If a Number is passed in with length of 0, throw an error')
        })
      })
    })
